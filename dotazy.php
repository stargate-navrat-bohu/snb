...
if ($PARAMS[2]!='www.sg-nb.cz')die('To už nezkoušejte');
}
...
<a href='hlavni.php?page=dotazy&vyber=2' id=b onMouseOver=Rozsvitit('b') onMouseOut=Zhasnout('b')>Dotazy nováèkù</a>
&nbsp;&nbsp;
...
?>
    ...
    <br><br><font class=text_bili><font class='text_modry'>D</font>otazy urèené adminùm hry </font>
  </center></h1>
...
echo "</table>";
	...
	$y=$x+30;
	$z=$x-30;
	echo "<br><br><center><font class='text_bili'><a href=hlavni.php?page=dotazy&x=".$z." >30 novìjších dotazù</a>&nbsp;&nbsp;";
	echo "<a href=hlavni.php?page=dotazy&x=".$y." >30 starších dotazù</a></font>";				
...
?>
    ...
    <br><br><font class=text_bili><font class='text_modry'>D</font>otazy nováèkù</font>
  </center></h1>
...
$casted=Date("U");
    ...
    echo"  <input type=submit value=pøidat name='submit'>"; ?>
    </td>
  </tr>
</table>
<p>&nbsp;</p></form>
...
<table border=1 width=100% align=center>
  <tr>
    <td align=center width="15%"><font class=text_modry><b>Vložil</b></font>
    <td align=center><font class=text_modry><b>Popis</b></font></td>
    <td align=center width="15%"><font class=text_modry><b>Vyjádøení uèitelù</b></font></td>
  </tr>
<?
...
if ($zaznam11[admin]==1 or $zaznam11[statusucitel]==1 or $zaznam11[admin]=='2'or $zaznam11[admin]=='3'or $zaznam11[admin]=='4'):
echo" 
