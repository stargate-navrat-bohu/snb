...
if(isset($smazdny)):
    $d=Date("U")-86400;
    $e=Date("U");
    if($smazdnyv<5){echo "Moc málo dnů";exit;};		
    if($smazdny<5){echo "Moc málo dnů";exit;};
    ...
    while($smaz = MySQL_Fetch_Array($smaz2)):
        ...
        echo " smaz�no ". $smaz[jmeno]." nebyl tu dn� ".$datum1."<br>";
        $jmen = $smaz[jmeno];			
...
if(isset($nezalog)):
    ...
    echo "<b>Celkem smaz�no: " . $koliksmaz . "</b><br>";
    while ($nez2 = MySQL_Fetch_Array($nez1)):
        ...
        echo "Smaz�n: <b>" . $nez2[jmeno] . "</b>; Registrov�n p�ed (dny): ";
...
<h6>Smazat</h6> 
nezmrazen�  hr��e  neaktivn� po <input type='text' name="smazdny" size=3> dn�,<br>
nezmr. vyvrhele(*) neaktivn� po <input type='text' name="smazdnyv" size=3> dn�,<br>
smazat maxim�ln� hr���(**) <input type='text' name="dnu" size=3><br>
<input type='submit' value="sma�">
</form>
<i>
(*)&nbsp;&nbsp;(implicitn� jako norm hr��e)<br>
(**)&nbsp;(implicitn� sma�e 50)
</i>
...
<h6>Smazat</h6> 
v�echny hr��e s nezadan�m reg. k�dem a registrac� star�� ne� 24h 
<input type='hidden' name="nezalog" value="1"><br>
<input type='submit' size=3 value="sma�"><br>
</form>

<br>
<form name='form1' method='post' action='hlavni.php?page=admin7'>
<h6>Smazat</h6> 
po�tu star�� jak <input type='text' name="posta" size=3> dn�,<br>
forum star�� jak <input type='text' name="forum" size=3> dn�,<br>
�tok star�� jak <input type='text' name="utok" size=3> dn�,<br>
�iny veden� star�� jak <input type='text' name="ciny" size=3> dn�.<br>
<input type='submit' value="sma�">
</form>
<i>
v�e je implicitn� 10 dn�<br>
minim�ln� 5 dn�
</i>
<?php
