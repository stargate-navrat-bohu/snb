...
<html>
  ...
  <head>
    ...
    <meta name="description" content="Stargate,Hvězdná brána,Stargate ,Sg-nb,serial Hvězdná brána,Online hra,Textová hra.">
    <meta name='keywords' content='Stargate,Hvězdná brána,Stargate ,Sg-nb,serial Hvězdná brána,Online hra,Textová hra,hra,webová hra,zábava.' lang='cs' />
...
echo "&nbsp;" . $logjmeno;
echo ", nejsi admin, tak nemáš přístup do admin sekce. Nemáš tu co dělat  a tímto bude tvá IP adresa zablokována? ";
exit;
}	
...
if($zaznam1[admin]==1){    
	...
	echo ' 
	    ...
	    <div class="menu_button"><a href="hlavni.php?page=kontr_uz" >Kontrola uživatelů</a></div>
	    <div class="menu_button"><a href="hlavni.php?page=silv_sms" >Silver přez SMS</a></div>
	    <div class="menu_button"><a href="hlavni.php?page=gold">Gold hráči</a></span></div>
	    <div class="menu_button"><a href="hlavni.php?page=admin17" >Restart</a></span></div>
	    <div class="menu_button"><a href="hlavni.php?page=aukro" >Odměny za aukro</a></span></div>
	    <div class="menu_button"><a href="hlavni.php?page=vytv_for" >Vytvořit forum</a></span></div>
	    <div class="menu_button"><a href="hlavni.php?page=ucet">RTG-účet</a></span></div>
	    ...
	    <div class="menu_button"><a href="hlavni.php?page=admin20">Systém nových hráčů</a></span></div>
	    <div class="menu_button"><a href="hlavni.php?page=admin11" >Úprava statistik</a></span></div>
	    <div class="menu_button"><a href="hlavni.php?page=admin10" >Činy vedení</a></span></div>
