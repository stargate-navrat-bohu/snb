...
<?
	...
	if(isset($rasa)):
		...
		echo "<tr>";
		echo "<th colspan=5>Rasová armáda rasy ".$ra[nazevrasy]."</th>";
		echo "</tr>";
		...
		echo "<th>Útok</th>";
		echo "<th>Obrana</th>";
		echo "<th>Poèet jednotek v RA</th>";
		echo "<th>Cena/ks</th>";
		echo "</tr>";
		...
		echo "<tr align=center>";
      echo "<td class=text_modry>".$ra["jed3_nazev"]."</td>";
      echo "<td class=text_modry>Proti pìchotì</td>";
      echo "<td><input type='text' value='".$ra["jed3_jed1"]."' name='nove_jed3_jed1' size='8'></td>";
      echo "<td class=text_modry>Proti univerzálum:</td>";
    ...
    echo "<tr align=center>";
      ...
      echo "<td class=text_modry>Proti orbitùm:</td>";
    ...
    echo "<tr align=center>";
      echo "<td class=text_modry>".$ra["jed3_nazev"]."</td>";
      echo "<td class=text_modry>Proti nájemným vrahùm:</td>";
      echo "<td><input type='text' value='".$ra["jed3_jed5"]."' name='nove_jed3_jed5' size='8'></td>";
      echo "<td class=text_modry>Proti zlodìjùm:</td>";
    ...
    echo "<tr align=center>";
      echo "<td class=text_modry>".$ra["jed3_nazev"]."</td>";
      echo "<td class=text_modry>Proti agentùm:</td>";
    ...
    echo "<tr align=center>";
      echo "<td class=text_modry>".$ra["jed3_nazev"]."</td>";
      echo "<td class=text_modry>Proti laboratoøím:</td>";
    ...
    echo"</tr>";
		...
		echo "<tr  align=center>";
		echo "<td colspan=5><input type='submit' value='Zmìnit'></td>";
		echo "</tr>";
		echo "</form>";
		echo "<br />";
		echo "<hr>";
