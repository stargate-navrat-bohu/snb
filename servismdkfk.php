...
if($zaznam1[jmeno]!='puchy2' and $zaznam1[jmeno]!='george111' and $zaznam1[jmeno]!='ACE1' and $zaznam1[jmeno]!='Bandur'){echo "<h1>Nejste admin proto nem�te p��stup do admin rozhran�.</h1>";exit;};

		@$vysledek = MySQL_Query("SELECT jmeno,admin,heslo,cislo,rasa FROM  uzivatele ORDER BY jmeno");
		if (!$vysledek):
		  echo "<h1>Bohu�el se nepoda�ilo p�ipojit k DB</h1>";
		  exit;
		endif;
...
<?php
				...
				elseif($dobre==0):
					echo "<h1>Chyba neexistuje tento u�ivatel</h1>";
				else:
...
<br><br>
<CENTER>
<h1>Toto je servisn� p��stup, jen pro zvann�.</h1>
<FONT class=info>
<P align=center><IMG src="hlavni_pozadi.jpg"> 
<P><FONT color=#cc6600>V</FONT><FONT color=#ffffff>�tejte na �vodn� str�nce hry 
STARGATE, inspirovanou televizn�m filmem a n�sledn� seri�lem stargate(hv�zdn� 
br�na). Abyste si mohli zahr�t sta�� se jen <A id=a onmouseover="Rozsvitit('a')" 
onmouseout="Zhasnout('a')" 
href="registrace.php">zaregistrovat</A> a pak se u� 
p�ihl�sit a hr�t. Doporu�uji si p�e��t <A id=b onmouseover="Rozsvitit('b')" 
onmouseout="Zhasnout('b')" href="help/" 
target=_blank>help</A>. Kdykoliv si sv�j profil m��ete <A id=c 
...
href="stat.php" target=_blank> zde</A>. Upozor�uji, �e tyto str�nky 
pot�ebuj� podporu javascriptu, kask�dov�ch styl� (cascading style sheet) a 
povolen� ukl�d�n� cookies. P�eji p��jemnou hru.&nbsp;</FONT> </P>
<P></FONT></P>
</font>
  ...
  <TR>
    <TD width=193 height=118>
      <TABLE height=112 width=194>
        <TBODY>
        <TR>
          <TD width=100 height=25><B><FONT class=kapital>J</FONT>m�no:</B> </TD>
        ...
        <TR>
          <TD width=100 height=19><B><FONT 
            class=kapital>P</FONT>rofil�:&nbsp;&nbsp;</B> </TD>
          <TD width=85 height=19><B><FONT color=#cc6600><?= $hhh?></FONT></B></TD></TR>
        <TR>
          <TD width=100 height=19><B><FONT 
            class=kapital>O</FONT>nline hr���:&nbsp;&nbsp;</B> </TD>
          <TD width=85 height=19><B><FONT color=#cc6600><?= $o?></FONT></B></TD></TR>
        <TR>
          <TD width=100 height=19><B><FONT 
            class=kapital>D</FONT>nes hr���:&nbsp;&nbsp;</B> </TD>
          <TD width=85 height=19><B><FONT color=#cc6600><?= $dnes?></FONT></B></TD></TR>		  
        <TR>
 <?php
	if($o<=100):	
		echo "<TD align=middle width=162 colSpan=2 height=27><B><INPUT type=submit value=P�ihla� name=B3></B>";
	else:
		echo "<TD align=middle width=162 colSpan=2 height=27><B>Je p��li� online hr���, zkuste pozd�ji.</B>";	
	endif;
?>
    <br><font class=info><a href="heslozap.php" id=e onmouseover="Rozsvitit('e')" onmouseout="Zhasnout('e')"><i>Zapomn�li jste sv� heslo?</i></a></font>
...
<P class=info align=left><FONT color=#ffffff>J�kekoliv dotazy pripom�nky mi 
piste na postu v sg na jm�no sg. Nebo na <A 
...
<TABLE width="34%" border=0>
  ...
  :.</FONT></TD></TR>
    ...
    <TD align=right width="34%"><FONT color=#ffffff>str�ce br�ny 
  :.</FONT></TD></TR>
    <TR>
    <TD width="33%"><FONT color=#ffffff>.: L��a Farj�k</FONT></TD>
    <TD align=middle width="33%"><FONT color=#cc6600>&nbsp;</FONT></TD>
...
<br><br>
<center><font class=info>Pou�it� obrazov� materi�ly z her s�rie Command&Conquer, Empire Earth, StarCraft, Warcraft, World of Warcraft, Civilization-3, Homeworld-2, Fallout Tactics, Fallout-2, Sid Meier's Alpha Centauri, Serious Sam, Treasure Planet: Battle for Natrolis, Age of Mythology, Republic:the revolution, Atlantia Underwordl Tyccon, Mafia, Imperium Galactica-3, ; seri�l� Star Trek:Voyager, Enterprise, Stargate SG-1 ; filmu Termin�tor-3 ; d�le pou�ity materi�ly (nejen obrazov�) z SG Game a 3D-UK.</font></center>
